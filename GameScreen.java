...
public class GameScreen extends JPanel implements Runnable, KeyListener {
	...
	public void gameUpdate() {						//a big update function consisting of small update functions
		if (gameState == GAME_PLAYING_STATE) {
			...
			/*if (enemiesManager.wasShot()) {						// inosaur attacks 
				enemiesManager.reset();						//enemy disappears ???
				mainCharacter.upScore(true);			//overload upscore
			}*/
			if(enemiesManager.coinCollision()) {
				mainCharacter.coinSound();
				enemiesManager.coinReset();
			}
		}
	}

	public void paint(Graphics g) {
		g.setColor(Color.decode("#B8EFE2"));  //B8EFE2  #f7f7f7
